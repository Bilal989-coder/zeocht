...
const GuideBookings = () => {
  const { bookings, loading, error } = useBookings("guide");
      ...
      <div className="container mx-auto px-4 py-8 max-w-6xl">
        <div className="mb-8">
          ...
          <p className="text-muted-foreground">
            Manage your upcoming and past livestream sessions with explorers
          </p>
        </div>
          ...
          <div className="mb-8">
            ...
            <div className="grid gap-4 md:grid-cols-2">
              {liveBookings.map((booking) => (
                <BookingCard key={booking.id} booking={booking} role="guide" />
              ))}
            </div>
          </div>
        )}
              ...
              <Card>
                <CardContent className="flex flex-col items-center justify-center py-12">
                  ...
                  <p className="text-sm text-muted-foreground text-center max-w-md">
                    You don't have any upcoming livestream sessions scheduled.
                  </p>
                </CardContent>
              </Card>
            )}
